...
interface SleepScoreTrendChartProps {
  data: Array<{ date: string; value: number; isAnomaly?: boolean }>
  height?: number
}

export default function SleepScoreTrendChart({ data, height = 300 }: SleepScoreTrendChartProps) {
  ...
  const CustomDot = (props: any) => {
    ...
    return <circle cx={cx} cy={cy} r={3} fill="#cccccc" />
  }
          ...
          <LineChart data={data}>
            ...
            <Tooltip
              ...
              formatter={(value: any, name: string, props: any) => {
                const parts = [`${value}/100`, 'Sleep Score']
